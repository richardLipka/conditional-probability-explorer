...
export const cs: Record<keyof typeof en, string> = {
  ...
  'controls.test2.note': 'Záložka Teorie je používá tak jako tak.',
  ...
  'controls.advanced': 'Další nastavení',
  ...
  'stream.trueScale': 'Šířka je počet lidí.',
  'stream.trueScale.exact': 'Každý proud je nakreslen ve své skutečné šířce.',
  'stream.trueScale.thin': 'Tyto kreslíme silnější, aby byly vidět: {list}',
